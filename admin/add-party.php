        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Add Party</a></li>
                                ...
                                <div class="basic-form">
                                    <form action="add-party.php" method="POST">
                                        ...
                                        <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">Party Name :</p>
                                                <input type="text" class="form-control input-rounded" name="party" placeholder="Please enter party name" required="required">
                                            </div>
