...
if (isset($_POST['submit'])) {
 $crud->insertType($_POST['election_type']);
}
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Add Type</a></li>
                                ...
                                <div class="basic-form">
                                    <form action="add-type.php" method="POST">
                                        ...
                                        <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">Election Type :</p>
                                                <input type="text" class="form-control input-rounded" name="election_type" placeholder="Please enter election type" required="required">
                                            </div>
