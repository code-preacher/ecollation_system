                                ...
                                <div class="basic-form">
                                    <form action="add-state.php" method="POST">
                                        ...
                                        <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">State Name :</p>
                                                <input type="text" class="form-control input-rounded" name="state" placeholder="Please enter state name" required="required">
                                            </div>
