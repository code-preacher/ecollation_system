        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Add Coordinator</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="add-cod.php" method="POST">
                                          
                                            <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">Select Party :</p>
                                                <select class="form-control input-rounded" name="party"  required="required">
                                    ...
                                    <?php  } ?>
                                            ...
                                            <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">Coordinator Name :</p>
                                                <input type="text" class="form-control input-rounded" name="name" placeholder="Please enter Coordinator name" required="required">
                                            </div>
