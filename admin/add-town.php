...
if (isset($_POST['submit'])) {
   $crud->insertTown($_POST['state'],$_POST['lga'],$_POST['town']);
}
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Add Town/District</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>ADD TOWN/DISTRICT</h4>

                                </div>

                                <div class="card-body">
                                    <div class="basic-form">
                                        <form action="add-town.php" method="POST">
                                     ...
                                     <div class="form-group">
                                        <p class="text-muted m-b-15 f-s-12">Town/District Name :</p>
                                        <input type="text" class="form-control input-rounded" name="town" placeholder="Please enter town/district name" required="required">
                                    </div>
