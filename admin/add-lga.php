...
if (isset($_POST['submit'])) {
 $crud->insertLga($_POST['state'],$_POST['lga']);
}
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Add Lga</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="add-lga.php" method="POST">
                                    ...
                                    <?php  } ?>
                                            ...
                                            <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">LGA Name :</p>
                                                <input type="text" class="form-control input-rounded" name="lga" placeholder="Please enter lga name" required="required">
                                            </div>
