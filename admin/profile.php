    ...
    $xx=$crud->displayProfile($_SESSION['id']);
    ?>
                                ...
                                <div class="basic-form">
                                 <form action="profile.php" method="POST">
                                      <div class="form-group">
                                        ...
                                        <input class="form-control input-rounded" required="required" value="<?php echo $xx['name'];  ?>"  disabled >
                                    </div>
                                    <div class="form-group">
                                        <p class="text-muted m-b-15 f-s-12">Email:</p>
                                        <input class="form-control input-rounded" required="required" value="<?php echo $xx['email'];  ?>"  disabled >
                                        <input type="hidden" class="form-control input-rounded" name="email" value=<?php echo $xx['email'];  ?>  >
                                    </div>
                                    <div class="form-group">
