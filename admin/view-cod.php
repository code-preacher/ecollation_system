...
$crud=new Crud;
$cod=$crud->displayAll('coordinator');

$lib=new Lib;

$lib->check_login();
if (isset($_GET['id'])) {
 $crud->delete($_GET['id'],'coordinator','view-cod.php');
}
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">View Cordinator</a></li>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="view-cod.php?id=<?=$t['id']?>"><i class="fa fa-trash text-danger"></i></a>
                                                </td>
                                            </tr>
                                             <?php  } ?>
