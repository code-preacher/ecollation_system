...
$crud=new Crud;
$pid=$crud->displayOne('agent',$_SESSION['id']);
$type=$crud->displayAllPartySpecificWithOrder('election',$pid['party'],$pid['id'],'id','desc');
$lib=new Lib;

$lib->check_login();

if (isset($_GET['id'])) {
 $crud->delete($_GET['id'],'election','view-result.php');
}
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="view-result.php?id=<?=$t['id']?>"><i class="fa fa-trash text-danger"></i></a>
                                                </td>
                                            </tr>
                                             <?php  } ?>
