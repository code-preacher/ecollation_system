...
$crud=new Crud;
$pd=$crud->displayAll('party');
$type=$crud->displayAllWithOrder('election_type','id','desc');
          ...
          <div class="col-lg-12">
            ...
            <div class="row page-titles">
                <div class="col-md-6 align-self-center">
                    <h3 class="text-primary">SECURED ELECTION COLLATION AND TRANSMISSION SYSTEM</h3> </div>
                <div class="col-md-6 align-self-center">
                    <ol class="breadcrumb">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td  style="font-weight: bolder;color: black;">
                                                    <?php
                                                    foreach ($pd as $pid) {
                                                   $cf=$crud->countAllVote('election',$pid['id'],$t['id']);
                                                     if ($cf) {
                                                        echo $pid['name']." (".$cf.") | ";
                                                     } else {
                                                        echo $pid['name']." (0) | ";
