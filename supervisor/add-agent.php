...
$lga=$crud->displayAll('lga');
$town=$crud->displayAll('town');
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form action="add-agent.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <p class="text-muted m-b-15 f-s-12">Party :</p>
                                        <input type="text" class="form-control input-rounded" value="<?php echo $crud->displayPartyId($_SESSION['id']); ?>" disabled>
                                    </div>

                                     <input type="hidden" class="form-control input-rounded" name="party" value="<?php echo $crud->displayPartyId2($_SESSION['id']); ?>">
                                         ...
                                         <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Select Lga :</p>
                                            <select class="form-control input-rounded" name="lga"  required="required">
                                                <?php foreach ($lga as $l) { ?>
                                                 <option value="<?=$l['id']?>"><?php echo $l['name']?></option>
                                             <?php  } ?>
                                         </select>
                                     </div>

                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Select Town/District :</p>
                                            <select class="form-control input-rounded" name="town"  required="required">
                                                <?php foreach ($town as $t) { ?>
                                                 <option value="<?=$t['id']?>"><?php echo $t['name']?></option>
                                             <?php  } ?>
                                         </select>
                                     </div>
